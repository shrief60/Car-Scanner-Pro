...
export default function QRDisplayScreen() {
  ...
  async function handleShare() {
    ...
    Alert.alert(
      'مشاركة QR',
      'في النسخة الكاملة يمكنك تحميل ومشاركة كود QR الخاص بسيارتك',
      [{ text: 'حسناً' }],
    );
  }
  ...
  async function handleDownload() {
    ...
    Alert.alert(
      'تحميل QR',
      'في النسخة الكاملة يمكنك تحميل كود QR كصورة وطباعتها على سيارتك',
      [{ text: 'حسناً' }],
    );
  }
  ...
  return (
    <View style={[styles.container, { paddingTop: topPad }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>كود QR</Text>
        <View style={{ width: 44 }} />
      </View>
      ...
      >
        ...
        <View style={styles.qrWrapper}>
          ...
          <Text style={styles.qrHint}>
            ضع هذا الكود على سيارتك لاستقبال التنبيهات
          </Text>
        </View>
        ...
        <View style={styles.actions}>
          ...
          >
            ...
            <Text style={styles.actionBtnTextPrimary}>تحميل QR</Text>
          </Pressable>
          ...
          >
            ...
            <Text style={styles.actionBtnTextSecondary}>مشاركة</Text>
          </Pressable>
        </View>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            عندما يمسح أحد هذا الكود سيتلقى خيارات لإرسال تنبيه لك دون الكشف
            عن رقم هاتفك
          </Text>
        </View>
