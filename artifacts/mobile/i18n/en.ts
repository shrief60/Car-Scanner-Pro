...
export const en = {
  ...
  home: {
    greeting: "Hello",
    tagline: "They reach you, not your number.",
  ...
  services: {
    ...
    maintenanceDescription:
      "Keep your car safe, reliable, and ready for the road.",
    accessoriesLabel: "Accessories",
    accessoriesSubtitle: "Upgrade your drive",
    accessoriesDescription:
      "Discover accessories that make every drive better.",
    ...
    remindersDescription:
      "Keep track of maintenance, renewals, and important dates.",
    sosLabel: "SOS",
  ...
  auth: {
    welcomeTagline: "Services, reminders and alerts for your car",
    ...
    googleEmailTaken:
      "This email already has a Qar account. Sign in with your existing method first.",
  ...
  serviceBrowser: {
    ...
    noServicesMaintenance:
      "No maintenance shops have published a menu in your area.",
    noServicesAccessories:
      "No accessories shops have published a menu in your area.",
  ...
  packages: {
    ...
    subtitle:
      "Unlock everything Qar can do for your car. You can change this later.",
